...
import {ITEMS,ZONES,XP,newState,parseSave,stats,equip,buy,spendPoint,questList,dialogue,choose,addItem,tasi,yeminler,sonMetni,SATICILAR,fiyat,type State,type ItemId,SURUM,ASAMA} from '@/lib/game/data';
